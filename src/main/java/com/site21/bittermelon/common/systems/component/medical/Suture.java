...
public record Suture(float efficiency, Optional<Identifier> icon) implements MedicalInstrument {
    ...
    public static final Codec<Suture> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Identifier.CODEC.optionalFieldOf("icon").forGetter(Suture::icon)
