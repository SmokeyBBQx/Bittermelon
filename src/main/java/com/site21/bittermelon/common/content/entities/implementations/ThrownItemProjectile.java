package com.site21.bittermelon.common.content.entities.implementations;
...
import static com.site21.bittermelon.init.neoforge.BitterDataComponents.WEIGHT;
...
public class ThrownItemProjectile extends ThrowableItemProjectile {
    ...
    protected void onHitBlock(@NotNull BlockHitResult result) {
        ...
        if (!this.level().isClientSide) {
            ...
            if (this.getItem().getItem() instanceof BitterItem item) {
