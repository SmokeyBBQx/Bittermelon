...
import com.site21.bittermelon.common.systems.component.screwdriver.ScrewdriverPose;
...
public class RepairToolUseAnimation implements IClientItemExtensions {
    ...
    public HumanoidModel.ArmPose getArmPose(@NotNull LivingEntity entity, @NotNull InteractionHand hand, @NotNull ItemStack stack) {
        return (stack.getUseAnimation() == RepairToolItem.REPAIR_TOOL_ANIMATION && entity.isUsingItem())
