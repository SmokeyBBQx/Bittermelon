...
public class StructuralBlockRenderer implements BlockEntityRenderer<StructuralBlockEntity> {
    ...
    @Override
    public void render(@NotNull StructuralBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay, @NotNull Vec3 cameraPos) {
