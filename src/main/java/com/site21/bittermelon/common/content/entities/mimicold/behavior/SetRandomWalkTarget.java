...
public class SetRandomWalkTarget<E extends MimicPlayer> extends ExtendedBehaviour<E> {
    ...
    protected Vec3 getTargetPos(E entity) {
        List<Player> players = BrainUtil.getMemory(entity, MemoryModuleType.NEAREST_PLAYERS);
        for (Player player : players) {
            if (player.isSpectator() || player.equals(entity))
                continue;
