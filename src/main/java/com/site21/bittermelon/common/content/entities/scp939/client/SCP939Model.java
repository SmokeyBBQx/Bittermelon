...
public class SCP939Model extends EntityModel<SCP939RenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition neck = front.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(68, 0).addBox(-4.5F, -14.0F, -1.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offset(1.3333F, 12.393F, -18.8372F));
        ...
        PartDefinition left_front_leg = front.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(68, 38).addBox(-0.3327F, -2.0714F, -1.3407F, 2.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(3.1661F, 1.4644F, -14.4965F));

        PartDefinition left_front_lower_leg = left_front_leg.addOrReplaceChild("left_front_lower_leg", CubeListBuilder.create().texOffs(82, 23).addBox(-0.9829F, -0.75F, -0.7135F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.4002F, 7.6786F, 1.3728F));

        PartDefinition left_front_foot = left_front_lower_leg.addOrReplaceChild("left_front_foot", CubeListBuilder.create().texOffs(0, 85).addBox(-0.9658F, 0.0F, -2.927F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.1F))
                ...
                .texOffs(38, 86).addBox(-0.9658F, 0.0F, -4.927F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0171F, 9.25F, 0.2135F));
        ...
        PartDefinition right_front_foot = right_front_lower_leg.addOrReplaceChild("right_front_foot", CubeListBuilder.create().texOffs(38, 86).mirror().addBox(0.9658F, 0.0F, -4.927F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(86, 17).mirror().addBox(-0.0342F, 0.0F, -4.927F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(60, 15).mirror().addBox(-1.0342F, 0.0F, -4.927F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 85).mirror().addBox(-1.0342F, 0.0F, -2.927F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.01F)).mirror(false), PartPose.offset(0.0171F, 9.375F, 0.9635F));
        ...
        PartDefinition left_hind_leg = body.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(68, 23).addBox(-0.7613F, -1.9286F, -1.4835F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.1661F, -0.2629F, -0.2944F));
        ...
        PartDefinition left_hind_foot = left_hind_lower_leg.addOrReplaceChild("left_hind_foot", CubeListBuilder.create().texOffs(62, 86).addBox(0.1341F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(88, 0).addBox(1.1341F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(66, 86).addBox(-0.8659F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(38, 79).addBox(-1.3659F, 0.0F, -3.777F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offset(-0.1341F, 10.75F, 0.527F));

        PartDefinition cube_r9 = left_hind_foot.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(58, 86).addBox(0.5F, -1.5F, -2.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.8659F, 1.5F, -3.277F, 0.0F, 0.3927F, 0.0F));

        PartDefinition right_hind_leg = body.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(68, 23).mirror().addBox(-2.2387F, -1.9286F, -1.4835F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.3566F, -0.2629F, -0.2944F));
        ...
        PartDefinition right_hind_foot = right_hind_lower_leg.addOrReplaceChild("right_hind_foot", CubeListBuilder.create().texOffs(62, 86).mirror().addBox(-0.1341F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(66, 86).mirror().addBox(0.8659F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(88, 0).mirror().addBox(-1.1341F, 0.0F, -5.777F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(38, 79).mirror().addBox(-1.6341F, 0.0F, -3.777F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offset(0.1341F, 10.75F, 0.277F));
