...
public class CommandSubstance {
    ...
    private static int addSubstanceContainer(CommandSourceStack source, String substance, int amount) {
        return 0;
    }
    ...
    private static int spawnFluidBlock(CommandSourceStack source) {
        ...
        if (source.getLevel().getBlockEntity(pos) instanceof FluidBlockEntity fluidBlockEntity) {
            fluidBlockEntity.updateSubstance(new SubstanceStack(WATER.get(), 1));
        }
