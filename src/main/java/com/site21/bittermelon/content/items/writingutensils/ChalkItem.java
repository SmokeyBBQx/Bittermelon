...
public class ChalkItem extends WallWriterItem implements WallWriter {
    ...
    protected void formatText(@NotNull WallWritingBlockEntity wallWriting, ItemStack stack) {
        wallWriting.updateText((text) -> text.setColor(stack.getOrDefault(BASE_COLOR, DyeColor.BLACK)));
    }
}
