...
@OnlyIn(Dist.CLIENT)
public class StructuralBlockEntityRenderer implements BlockEntityRenderer<StructuralBlockEntity> {
    public StructuralBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        super();
    }
