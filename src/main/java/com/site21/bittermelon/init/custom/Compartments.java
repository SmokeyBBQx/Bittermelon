...
public class Compartments {
    ...
    public static final DeferredHolder<Compartment, Compartment> TORSO = COMPARTMENTS.register("torso",
            () -> new Compartment("torso", new Compartment.Properties()
                    .defaultHealth(150)
                    .layers(
                            LayerData.fromRegularShape("Skin", 25, 45, SlotType.SKIN),
            ...
            () -> new Compartment("upper_arm", new Compartment.Properties()
                    ...
                    .layers(
                            ...
                            new LayerData("Bone", 16, 5, List.of(
                                    ...
                                    new SlotPoint(15, 0, SlotType.BONE),
                                    ...
                                    new SlotPoint(6, 2, SlotType.BONE),
                                    new SlotPoint(7, 2, SlotType.BONE),
                                    new SlotPoint(8, 2, SlotType.BONE),
                                    new SlotPoint(9, 2, SlotType.BONE),
                                    new SlotPoint(10, 2, SlotType.BONE),
                                    new SlotPoint(11, 2, SlotType.BONE),
                                    new SlotPoint(12, 2, SlotType.BONE),
                                    new SlotPoint(13, 2, SlotType.BONE),
                                    new SlotPoint(14, 2, SlotType.BONE),
                                    new SlotPoint(15, 2, SlotType.BONE),
                                    new SlotPoint(0, 3, SlotType.BONE),
                                    new SlotPoint(1, 3, SlotType.BONE),
                                    new SlotPoint(2, 3, SlotType.BONE),
                                    ...
                                    new SlotPoint(15, 3, SlotType.BONE),
