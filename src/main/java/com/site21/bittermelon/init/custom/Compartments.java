...
public class Compartments {
    ...
    public static final DeferredHolder<Compartment, Compartment> STOMACH = COMPARTMENTS.register("stomach",
            () -> new Compartment("stomach", new Compartment.Properties()
                    ...
                    .layers(new LayerData("Stomach Tissue", 14, 16, List.of( new SlotPoint(6, 0, SlotType.ORGAN), new SlotPoint(5, 1, SlotType.ORGAN), new SlotPoint(6, 1, SlotType.ORGAN), new SlotPoint(7, 1, SlotType.ORGAN), new SlotPoint(10, 1, SlotType.ORGAN), new SlotPoint(11, 1, SlotType.ORGAN), new SlotPoint(5, 2, SlotType.ORGAN), new SlotPoint(6, 2, SlotType.ORGAN), new SlotPoint(7, 2, SlotType.ORGAN), new SlotPoint(9, 2, SlotType.ORGAN), new SlotPoint(10, 2, SlotType.ORGAN), new SlotPoint(11, 2, SlotType.ORGAN), new SlotPoint(12, 2, SlotType.ORGAN), new SlotPoint(5, 3, SlotType.ORGAN), new SlotPoint(6, 3, SlotType.ORGAN), new SlotPoint(7, 3, SlotType.ORGAN), new SlotPoint(8, 3, SlotType.ORGAN), new SlotPoint(9, 3, SlotType.ORGAN), new SlotPoint(10, 3, SlotType.ORGAN), new SlotPoint(11, 3, SlotType.ORGAN), new SlotPoint(12, 3, SlotType.ORGAN), new SlotPoint(13, 3, SlotType.ORGAN), new SlotPoint(6, 4, SlotType.ORGAN), new SlotPoint(7, 4, SlotType.ORGAN), new SlotPoint(8, 4, SlotType.ORGAN), new SlotPoint(9, 4, SlotType.ORGAN), new SlotPoint(10, 4, SlotType.ORGAN), new SlotPoint(11, 4, SlotType.ORGAN), new SlotPoint(12, 4, SlotType.ORGAN), new SlotPoint(13, 4, SlotType.ORGAN), new SlotPoint(7, 5, SlotType.ORGAN), new SlotPoint(8, 5, SlotType.ORGAN), new SlotPoint(9, 5, SlotType.ORGAN), new SlotPoint(10, 5, SlotType.ORGAN), new SlotPoint(11, 5, SlotType.ORGAN), new SlotPoint(12, 5, SlotType.ORGAN), new SlotPoint(13, 5, SlotType.ORGAN), new SlotPoint(7, 6, SlotType.ORGAN), new SlotPoint(8, 6, SlotType.ORGAN), new SlotPoint(9, 6, SlotType.ORGAN), new SlotPoint(10, 6, SlotType.ORGAN), new SlotPoint(11, 6, SlotType.ORGAN), new SlotPoint(12, 6, SlotType.ORGAN), new SlotPoint(13, 6, SlotType.ORGAN), new SlotPoint(7, 7, SlotType.ORGAN), new SlotPoint(8, 7, SlotType.ORGAN), new SlotPoint(9, 7, SlotType.ORGAN), new SlotPoint(10, 7, SlotType.ORGAN), new SlotPoint(11, 7, SlotType.ORGAN), new SlotPoint(12, 7, SlotType.ORGAN), new SlotPoint(2, 8, SlotType.ORGAN), new SlotPoint(3, 8, SlotType.ORGAN), new SlotPoint(4, 8, SlotType.ORGAN), new SlotPoint(6, 8, SlotType.ORGAN), new SlotPoint(7, 8, SlotType.ORGAN), new SlotPoint(8, 8, SlotType.ORGAN), new SlotPoint(9, 8, SlotType.ORGAN), new SlotPoint(10, 8, SlotType.ORGAN), new SlotPoint(11, 8, SlotType.ORGAN), new SlotPoint(12, 8, SlotType.ORGAN), new SlotPoint(1, 9, SlotType.ORGAN), new SlotPoint(2, 9, SlotType.ORGAN), new SlotPoint(3, 9, SlotType.ORGAN), new SlotPoint(4, 9, SlotType.ORGAN), new SlotPoint(5, 9, SlotType.ORGAN), new SlotPoint(6, 9, SlotType.ORGAN), new SlotPoint(7, 9, SlotType.ORGAN), new SlotPoint(8, 9, SlotType.ORGAN), new SlotPoint(9, 9, SlotType.ORGAN), new SlotPoint(10, 9, SlotType.ORGAN), new SlotPoint(11, 9, SlotType.ORGAN), new SlotPoint(0, 10, SlotType.ORGAN), new SlotPoint(1, 10, SlotType.ORGAN), new SlotPoint(2, 10, SlotType.ORGAN), new SlotPoint(3, 10, SlotType.ORGAN), new SlotPoint(4, 10, SlotType.ORGAN), new SlotPoint(5, 10, SlotType.ORGAN), new SlotPoint(6, 10, SlotType.ORGAN), new SlotPoint(7, 10, SlotType.ORGAN), new SlotPoint(8, 10, SlotType.ORGAN), new SlotPoint(9, 10, SlotType.ORGAN), new SlotPoint(10, 10, SlotType.ORGAN), new SlotPoint(11, 10, SlotType.ORGAN), new SlotPoint(0, 11, SlotType.ORGAN), new SlotPoint(1, 11, SlotType.ORGAN), new SlotPoint(2, 11, SlotType.ORGAN), new SlotPoint(4, 11, SlotType.ORGAN), new SlotPoint(5, 11, SlotType.ORGAN), new SlotPoint(6, 11, SlotType.ORGAN), new SlotPoint(7, 11, SlotType.ORGAN), new SlotPoint(8, 11, SlotType.ORGAN), new SlotPoint(9, 11, SlotType.ORGAN), new SlotPoint(10, 11, SlotType.ORGAN), new SlotPoint(0, 12, SlotType.ORGAN), new SlotPoint(1, 12, SlotType.ORGAN), new SlotPoint(2, 12, SlotType.ORGAN), new SlotPoint(6, 12, SlotType.ORGAN), new SlotPoint(7, 12, SlotType.ORGAN), new SlotPoint(8, 12, SlotType.ORGAN), new SlotPoint(1, 13, SlotType.ORGAN), new SlotPoint(2, 13, SlotType.ORGAN), new SlotPoint(3, 13, SlotType.ORGAN), new SlotPoint(2, 14, SlotType.ORGAN), new SlotPoint(3, 14, SlotType.ORGAN), new SlotPoint(4, 14, SlotType.ORGAN), new SlotPoint(3, 15, SlotType.ORGAN) )))
