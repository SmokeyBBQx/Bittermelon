...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractContainerScreenDuplicate<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
    ...
    protected static final float SNAPBACK_SPEED = 100.0F;
    protected static final int QUICKDROP_DELAY = 500;
    public static final int SLOT_ITEM_BLIT_OFFSET = 100;
    protected static final int HOVER_ITEM_BLIT_OFFSET = 200;
    ...
    public AbstractContainerScreenDuplicate(T pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pTitle);
        this.menu = pMenu;
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new ContainerScreenEventDuplicate.Render.Background(this, pGuiGraphics, pMouseX, pMouseY) {
        });
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new ContainerScreenEventDuplicate.Render.Foreground(this, pGuiGraphics, pMouseX, pMouseY));
    ...
    protected void renderFloatingItem(GuiGraphics pGuiGraphics, ItemStack pStack, int pX, int pY, String pText) {
        pGuiGraphics.pose().pushPose();
    ...
    protected void checkHotbarMouseClicked(int pKeyCode) {
    ...
    protected boolean isHovering(Slot pSlot, double pMouseX, double pMouseY) {
